...
public interface RemoteControl {// 인터페이스 선언
	...
	// 구성멤버 
		...
		// 2. public 추상 메소드			[public abstract] 선언부 -> 구현객체 필요하다 -> class가 구현을 해줘야하기 때문에
		void turnOn();
		public abstract void turnOff();
		void setVolume(int volume);
		
		
		// 3. public 디폴트 메소드			[public] default : 선언부 + 실행부 => 구현객체가 필요
		...
		// 4. public 정적(객체없이) 메소드 	[public] static : 선언부 + 실행부 -> 구현객체가 필요없다
