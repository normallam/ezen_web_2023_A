...
// 문제4
let 정수1 = prompt(' 정수1 : ');		console.log( '정수1 : ' + ( 정수1%2 == 1 ) );

// 문제5
let 정수2 = prompt(' 정수2 : ');		console.log( '정수2 : ' + ( 정수2%7 == 0 ) );
...
//5.증감연산자[ data+1 , data+=1 , data++ ] /*순차처리 할 떄 용이*/
let 데이터2 = 10; 
...
console.log('data:' + (데이터2--)); //12에서 1감소 => 11???? 12 [출력 후에 감소]
console.log('data:' + 데이터2);	//11
...
console.log('두 정수 중 더 큰수 :' + (value1>value2 ? value1 : value2));
console.log('두 정수 중 더 큰수 :' + (value1>value2 ? value1 : value1<value2 ? value2 : '두 수는 같다.' ));
...
max = max < value4 ? value4 : max // 2. 만약에 max보다 두번쨰 입력값이 더 크면 max변수에 두번쨰 값을 저장/ 아니면 그대로
max = max < value5 ? value5 : max // 3. 만약에 max보다 세번째 입역값이 더 크면 교체 / 아니면 그대로
