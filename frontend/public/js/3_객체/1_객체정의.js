 	...
 	JS : 객체 지향 언어[OOP: Object Oriented Programming]
 		...
 		JS 객체 =	 JSON
 			2. JS 메모리
 				...
 				2. 상수 = 데이터
 				3. 배열 = [데이터1, 데이터2, 데이터3]
 						- 배열 단점 : 서로 다른 정부유형들을 하나의 배열에 관리 어렵다!!!
 ...
 */
 ...
 console.log('아이디속성 호출:'+ 객체1.아이디)	//객체1의 특정(아이디) 속성내 호출
 console.log('비밀번호속성 호출:'+ 객체1.비밀번호)	//객체 내 속성 알고 있으면 데이터 호출 가능하다.
 ...
 //4. 객체내 속성 추가
 객체1.주소='안산';		//[추가]객체내 주소 속성이 없으므로 호출이 아닌 추가되서 값 대입
 console.log(객체1)
 
 //5. 객체내 속성 삭제
 delete 객체1.주소;	//[삭제] 객체내 속성이 삭제되면데이터도 같이 삭제
 console.log(객체1)
 
 
 //6. 여러개의 동일한 유형의 객체(속성명)를 하나의 배열 저장
